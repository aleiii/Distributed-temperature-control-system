...
| 系统事件 | CreateRDR(RoomId, Date_In, Date_out)   |
| -------- | -------------------------------------- |
| 交叉引用 | 出具详单                               |
| 说明     | 前台根据房间号及入住的时间段出具详单   |
| 返回     | Return(list_RDR(RoomUd,Requestime,… )) |
| 前置条件 | 客户退房请求出具详单                   |
| 后置条件 | 1. 服务对象被创建                      |
|          | 2. 详单对象被创建                      |
|          | 3. 详单所有属性被赋值                  |
